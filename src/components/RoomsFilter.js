            ...
            <form className="filter-form">
                ...
                <div className="form-group">
                    ...
                    <input type="range" name="price" value={price}
                        id="price" min={minPrice} max={maxPrice} onChange={handleChange} className="form-control" />
                </div>
                {/*  end of room price */}
                 ...
                 <div className="form-group">
                    ...
                    id="breakfast"  onChange={handleChange} checked = {breakfast}/>
                    <label htmlFor="breakfast">breakfast</label>

                    <div className="form-group">
                    <div className = "single-extra">
                    <input type="checkbox" name="pets" 
                    id="pets"  onChange={handleChange} checked = {pets}/>
